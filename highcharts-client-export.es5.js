...
(function (H) {
  ...
  var supportStatus = {};
  var buildSupportStatus = function buildSupportStatus() {
    ...
    var canvgSupport = typeof canvg !== 'undefined' && typeof RGBColor != 'undefined' && rbgColorSupport && canvas.getContext && canvas.getContext('2d');
   ...
   */
  var svgToCanvas = function svgToCanvas(svg, width, height, callback) {
    var canvas = document.createElement('canvas');
  ...
  var Opt = function () {
    function Opt(opts1, opt2, dotdotdot) {
    ...
    _createClass(Opt, [{
      ...
      value: function get(key) {
        for (var _i = 0; _i < this.bundles.length; _i++) {
          if (this.bundles[_i] && this.bundles[_i][key] !== undefined) {
            return this.bundles[_i][key];
          }
        }
  ...
  var preRenderCsvXls = function preRenderCsvXls(highChartsObject, options, chartOptions) {
    ...
    var oldOptions = {};
    var optionsToCopy = ['dateFormat', 'itemDelimiter', 'lineDelimiter'];
    var optionToCopy = void 0;
    for (var _i2 in optionsToCopy) {
      optionToCopy = optionsToCopy[_i2];
  ...
  var renderCsv = function renderCsv(highChartsObject, context, callback) {
    var data = {
      content: undefined,
      datauri: undefined,
      blob: undefined
  ...
  var renderXls = function renderXls(highChartsObject, context, callback) {
    var data = {
      content: undefined,
      datauri: undefined,
      blob: undefined
    ...
    var xls = (context.useBOM ? UTF8_BOM : '') + '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel"xmlns="http://www.w3.org/TR/REC-html40"><head><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>Sheet</x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--><style>td{border:none;font-family: Calibri, sans-serif;} .number{mso-number-format:"0.00";}</style><meta name=ProgId content=Excel.Sheet></head><body>' + highChartsObject.getTable(context.useLocalDecimalPoint) + '</body></html>';
    data.content = xls;
  ...
  var preRenderImage = function preRenderImage(highChartsObject, options, chartOptions) {
    var opt = new Opt(options, highChartsObject.options.exporting, defaultExportOptions);

    var scale = opt.get('scale');
    var sourceWidth = highChartsObject.options.width || opt.get('sourceWidth') || highChartsObject.chartWidth;
    var sourceHeight = highChartsObject.options.height || opt.get('sourceHeight') || highChartsObject.chartHeight;
  ...
  var renderSvg = function renderSvg(highChartsObject, context, callback) {
    var data = {
      content: undefined,
      datauri: undefined,
      blob: undefined
  ...
  var renderPngJpeg = function renderPngJpeg(highChartsObject, context, callback) {
    var data = {
      content: undefined,
      datauri: undefined,
      blob: undefined
  ...
  var renderPdf = function renderPdf(highChartsObject, context, callback) {
    var data = {
      content: undefined,
      datauri: undefined,
      blob: undefined
  ...
  var download = function download(highChartsObject, context, data) {
